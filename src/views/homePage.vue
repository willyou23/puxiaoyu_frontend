...
<!--    <div class="goods">-->
<!--&lt;!&ndash;      <li class="card-line" v-for="i in 13">&ndash;&gt;-->
...
<template>
    ...
    <div class="tab">
<!--      <Classification class="tab-control" :titles="['All','Costume','Cosmetics','Electronic Products','Commodity','']"/>-->
      <div class="class">
        <div v-for="(item,index) in ['All','Costume','Cosmetics','Electronic Products','Commodity','']"
             class="class-item"
