...
<template>
    <div>
            ...
            <div style="text-align: right;margin-right: 0">
                ...
                <el-dropdown>
                    ...
                    <el-dropdown-menu slot="dropdown" >
                        ...
                        <el-dropdown-item>
                            <el-button size="medium" style="width: 120px" @click="account">Profile</el-button>
                        </el-dropdown-item>
                    </el-dropdown-menu>
                </el-dropdown>
            </div>
        ...
        <el-container style="height: 700px; border: 2px solid #eee">
            ...
            <el-container>
                <el-header style="text-align: left; font-size: 20px; font-family: 幼圆; color: black;background-color: rgba(255, 224, 141, 1);margin-top: 15px">
                    <span>已发布商品</span>
                    <el-button style="margin-left: 750px" icon="el-icon-plus" circle ></el-button>
                </el-header>
                ...
                <el-main>
                    <el-table :data="tableData">
                        ...
                        <el-table-column label="删除" width="120"style="margin-right: 10px">
                            <el-button icon="el-icon-delete" circle @click="() => deleteItem(data)"></el-button>
                        </el-table-column>
                    </el-table>
                </el-main>

                <el-header style="text-align: left; font-size: 20px; font-family: 幼圆; color: black;background-color: rgba(255, 224, 141, 1)">
                    <span>已购买商品</span>
                    <el-button style="margin-left: 750px" icon="el-icon-star-on" circle></el-button>
                </el-header>
                <el-main>
